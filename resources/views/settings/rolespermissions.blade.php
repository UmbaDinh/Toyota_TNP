    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div class="sidebar-menu">
                <ul>
                    <li><a href="{{ route('home') }}"><i class="la la-home"></i> <span>Trở về trang chủ</span></a></li>
                    ...
                    <li><a href="{{ route('roles/permissions/page') }}"><i class="la la-key"></i><span>Vai trò & Quyền</span></a></li>
                    ...
                    <li><a href="{{ route('change/password') }}"><i class="la la-lock"></i><span>Đổi mật khẩu</span></a></li>
